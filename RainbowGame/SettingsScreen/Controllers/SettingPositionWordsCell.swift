//
//  SettingsPositionWordsCell.swift
//  RainbowGame
//
...
final class SettingsPositionWordsCell: UICollectionViewCell {
	
	static let id = "settingsPositionWordsCell"
	
//	var segmentedControlValueChanged: ((Int) -> Void)?
	
	private let titleLabel = UILabel()
	private let segmetedControl = UISegmentedControl(items: ["Случайное", "По центру"])
	...
	private func setupUI() {
		...
		titleLabel.text = "Расположение слова на экране"
